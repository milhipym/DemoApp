...
public class StarbuksBottomSheetActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.start_fragment_container,
                            StarbuksBottomSheetFragment.newInstance("home"))
                    .commit();
        ...
        navView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.starbucks_home) {
                selectedFragment = StarbuksBottomSheetFragment.newInstance("home");
            } else if (itemId == R.id.starbucks_pay) {
                selectedFragment = StarbuksBottomSheetFragment.newInstance("pay");
            } else if (itemId == R.id.starbucks_order) {
                selectedFragment = StarbuksBottomSheetFragment.newInstance("order 화면입니다");
            } else if (itemId == R.id.starbucks_shop) {
                selectedFragment = StarbuksBottomSheetFragment.newInstance("shop 화면입니다");
            } else if (itemId == R.id.starbucks_other) {
                selectedFragment = StarbuksBottomSheetFragment.newInstance("other 화면입니다");
            }
            getSupportFragmentManager().beginTransaction()
