...
public class StarbuksRecyclerViewIndicatorAdapter extends RecyclerView.Adapter<StarbuksRecyclerViewIndicatorAdapter.CardViewHolder> {
    private final List<Integer> imageList;
    private final List<String> indicatorList;

    public StarbuksRecyclerViewIndicatorAdapter(List<Integer> imageList, List<String> indicatorList) {
    ...
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StarbuksRecyclerViewIndicatorAdapter.CardViewHolder(view);
    }
