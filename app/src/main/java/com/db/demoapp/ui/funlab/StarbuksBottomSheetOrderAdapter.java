...
public class StarbuksBottomSheetOrderAdapter extends RecyclerView.Adapter<StarbuksBottomSheetOrderAdapter.ViewHolder>{

    private final List<StarbuksBottomSheetOrderAdapter.DrinkItem> drinkItems;

    public StarbuksBottomSheetOrderAdapter(List<StarbuksBottomSheetOrderAdapter.DrinkItem> drinkItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.starbuks_pay_screen_bottomsheet_order_items, parent, false);
