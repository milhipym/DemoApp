...
public class StarbuksAppbarCollapActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.start_fragment_container,
                            StarbuksAppbarCollapFragment.newInstance("home"))
                    .commit();
        ...
        navView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.starbucks_home) {
                selectedFragment = StarbuksAppbarCollapFragment.newInstance("home");
            } else if (itemId == R.id.starbucks_pay) {
                selectedFragment = StarbuksAppbarCollapFragment.newInstance("pay 화면입니다");
            } else if (itemId == R.id.starbucks_order) {
                selectedFragment = StarbuksAppbarCollapFragment.newInstance("order 화면입니다");
            } else if (itemId == R.id.starbucks_shop) {
                selectedFragment = StarbuksAppbarCollapFragment.newInstance("shop 화면입니다");
            } else if (itemId == R.id.starbucks_other) {
                selectedFragment = StarbuksAppbarCollapFragment.newInstance("other 화면입니다");
            }
            getSupportFragmentManager().beginTransaction()
