...
public class StarbuksRecyclerViewOrderAdapter  extends RecyclerView.Adapter<StarbuksRecyclerViewOrderAdapter.ViewHolder>{

    private final List<StarbuksRecyclerViewOrderAdapter.DrinkItem> drinkItems;

    public StarbuksRecyclerViewOrderAdapter(List<StarbuksRecyclerViewOrderAdapter.DrinkItem> drinkItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.starbuks_home_screen_recycle_order_items, parent, false);
