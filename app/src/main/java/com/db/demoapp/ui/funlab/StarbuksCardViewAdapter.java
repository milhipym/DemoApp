...
public class StarbuksCardViewAdapter extends RecyclerView.Adapter<StarbuksCardViewAdapter.ViewHolder> {

    private final List<DrinkItem> drinkItems;

    public StarbuksCardViewAdapter(List<DrinkItem> drinkItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.starbuks_home_screen_carcview_items, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(DrinkItem item) {
            ...
            txtCoffeeSub.setText(item.getSub()); // e.g., "ICED" or "HOT"
        }
    }
